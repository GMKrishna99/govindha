    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.typeContainer}>
            <TouchableOpacity
              style={[
                styles.typeButton,
                newAddress.type === 'Home' && styles.typeButtonActive,
              ]}
              onPress={() => handleChange('type', 'Home')}>
              <Icon
                name="home-outline"
                size={20}
                color={newAddress.type === 'Home' ? '#D4AF37' : '#888'}
              />
              <Text
                style={[
                  styles.typeButtonText,
                  newAddress.type === 'Home' && styles.typeButtonTextActive,
                ]}>
                Home
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={[
                styles.typeButton,
                newAddress.type === 'Work' && styles.typeButtonActive,
              ]}
              onPress={() => handleChange('type', 'Work')}>
              <Icon
                name="business-outline"
                size={20}
                color={newAddress.type === 'Work' ? '#D4AF37' : '#888'}
              />
              <Text
                style={[
                  styles.typeButtonText,
                  newAddress.type === 'Work' && styles.typeButtonTextActive,
                ]}>
                Work
              </Text>
            </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => handleChange('isDefault', !newAddress.isDefault)}>
